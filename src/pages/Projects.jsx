    ...
    <>
      ...
      <div className="portfolio-page">
        ...
        <article className="web-dev-intro">
          ...
          accessibility. Committed to creating inclusive digital experiences, I
          have deepened my knowledge through extensive study and completion of
          the W3Cx: Introduction to Web Accessibility course, enabling me to
          develop user-friendly and compliant products.
        </article>
